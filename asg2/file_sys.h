// $Id: file_sys.h,v 1.7 2019-07-11 12:30:13-07 - - $
...
class inode_state {
   ...
   public:
      ...
      void set_prompt(const string&); // set new prompt
      inode_ptr find_inode(string) const;
...
class base_file {
   ...
   public:
      ...
      virtual void remove_recurrsive (const string& filename) = 0;
      ...
      virtual string get_abs_path() const = 0;
      virtual void set_abs_path(string) = 0; 
};

// class plain_file -
// Used to hold data.
...
class plain_file: public base_file {
   ...
   public:
      ...
      virtual void remove_recurrsive (const string& filename) override;
      virtual inode_ptr mkdir (const string& dirname) override;
      virtual inode_ptr mkfile (const string& filename) override;
      virtual wordvec& get_data() override;
      virtual map<string, inode_ptr>& get_dirents() override;
      virtual string type() const override;
      virtual string get_abs_path() const override;
      virtual void set_abs_path(string) override; 
};
